...
f1_IMDB_svc_tunned_train = f1_IMDB_svc = f1_svc(X_IMDB_train,y_IMDB_train,X_IMDB_train,y_IMDB_train,best_is,best_iteration,best_state,best_tol)
...
#f1 for train data with tunned svm
f1_IMDB_svc_tunned_valid = f1_yelp_svc = f1_svc(X_IMDB_train,y_IMDB_train,X_IMDB_valid,y_IMDB_valid,best_is,best_iteration,best_state,best_tol)
...
f1_IMDB_svc_tunned_test = f1_yelp_svc = f1_svc(X_IMDB_train,y_IMDB_train,X_IMDB_test,y_IMDB_test,best_is,best_iteration,best_state,best_tol)
