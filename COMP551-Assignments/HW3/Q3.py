...
f1_yelp_nb_tunned_train_f = f1_NB(X_yelp_train_fre,y_yelp_train_fre,X_yelp_train_fre,y_yelp_train_fre)
...
#valid set
#f1 for train data with tunned naive bayes 
f1_yelp_nb_tunned_valid_f = f1_NB(X_yelp_train_fre,y_yelp_train_fre,X_yelp_valid_fre,y_yelp_valid_fre)
...
f1_yelp_nb_tunned_test_f = f1_NB(X_yelp_train_fre,y_yelp_train_fre,X_yelp_test_fre,y_yelp_test_fre)
